 ...
 */
public class CardViewPager3 extends ViewGroup {
    private int mScreenWidth;
    private Scroller mScroller;

    public CardViewPager3(Context context) {
        super(context);
        init(context);
    }

    public CardViewPager3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CardViewPager3(Context context, AttributeSet attrs, int defStyleAttr) {
