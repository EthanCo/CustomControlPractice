...
/**
 * Created by EthanCo on 2016/8/9.
 */
public class BallSpinFadeLoaderIndicator extends BaseIndicatorController {
    ...
    private static final String TAG = "Z-Ball";
    ...
    public void draw(Canvas canvas, Paint paint) {
        ...
        for (int i = 0; i < 8; i++) {
            canvas.save();
            Point point = circleAt(getWidth(), getHeight(), getWidth() / 2 - radius, i * (Math.PI / 4)); /*PI/4=45°*/
