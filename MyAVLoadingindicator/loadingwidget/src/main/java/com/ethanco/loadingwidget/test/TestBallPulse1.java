 ...
 */
public class TestBallPulse1 extends View {
    ...
    public TestBallPulse1(Context context) {
        super(context);
        init(null, 0);
    }

    public TestBallPulse1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public TestBallPulse1(Context context, AttributeSet attrs, int defStyleAttr) {
