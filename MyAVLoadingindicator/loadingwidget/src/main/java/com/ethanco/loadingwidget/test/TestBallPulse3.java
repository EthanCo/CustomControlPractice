 ...
 */
public class TestBallPulse3 extends View {
    ...
    public TestBallPulse3(Context context) {
        super(context);
        init(null, 0);
    }

    public TestBallPulse3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public TestBallPulse3(Context context, AttributeSet attrs, int defStyleAttr) {
